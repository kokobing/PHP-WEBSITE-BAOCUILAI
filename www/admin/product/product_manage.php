            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td bgcolor="#FFFFFF"><span onclick="needupfile(<?php echo $oneproductinfo[id_prodinfo];?>,'../../upload/product/','|jpg|jpeg|pdf|rar|png','/admin/product/ajax_upfileindata.php');" style="cursor:pointer">文件上传...</span>
...
<? }else if($onenewspicinfo[$i][type]=="PNG"){?>
